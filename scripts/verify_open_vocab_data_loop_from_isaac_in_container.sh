...
VERIFY_PID="$(
  docker exec -u ubuntu "$CONTAINER_NAME" bash -lc "
    ...
    export A1Z_D405_PARENT_PRIM='${A1Z_D405_PARENT_PRIM:-}'
    export A1Z_D405_FALLBACK_PARENT_PRIM='${A1Z_D405_FALLBACK_PARENT_PRIM:-}'
    export A1Z_D405_FK_FRAME='${A1Z_D405_FK_FRAME:-}'
    export A1Z_D405_BODY_VISUAL_RPY_DEG='${A1Z_D405_BODY_VISUAL_RPY_DEG:-}'
    export A1Z_D405_STAGE_MOUNT_OFFSET_XYZ_M='${A1Z_D405_STAGE_MOUNT_OFFSET_XYZ_M:-}'
    export A1Z_D405_STAGE_MOUNT_RPY_DEG='${A1Z_D405_STAGE_MOUNT_RPY_DEG:-}'
    export A1Z_D405_STAGE_RECTIFY_RPY_DEG='${A1Z_D405_STAGE_RECTIFY_RPY_DEG:-}'
    export A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_OFFSET_XYZ_M='${A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_OFFSET_XYZ_M:-}'
    export A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_RPY_DEG='${A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_RPY_DEG:-}'
    export A1Z_D405_CAMERA_PRIMS_ENABLED='${A1Z_D405_CAMERA_PRIMS_ENABLED:-}'
    export A1Z_D405_CENTER_MESH_Y='${A1Z_D405_CENTER_MESH_Y:-}'
    export A1Z_D405_CENTER_ON_AXIS='${A1Z_D405_CENTER_ON_AXIS:-}'
    export A1Z_D405_STATUS_PATH='${A1Z_D405_STATUS_PATH:-}'
    export A1Z_D405_ROS2_NAMESPACE='${A1Z_D405_ROS2_NAMESPACE:-}'
    export A1Z_D405_RECTIFIED_FRAME_ID='${A1Z_D405_RECTIFIED_FRAME_ID:-}'
    export A1Z_D405_COLOR_FRAME_ID='${A1Z_D405_COLOR_FRAME_ID:-}'
    export A1Z_D405_DEPTH_FRAME_ID='${A1Z_D405_DEPTH_FRAME_ID:-}'
    export A1Z_D405_WIDTH='${A1Z_D405_WIDTH:-}'
    export A1Z_D405_HEIGHT='${A1Z_D405_HEIGHT:-}'
    export A1Z_D405_FRAME_SKIP_COUNT='${A1Z_D405_FRAME_SKIP_COUNT:-}'
