...
DOCKER_ENV_ARGS=(
  ...
  -e "A1Z_D405_STAGE_MOUNT_OFFSET_XYZ_M=${A1Z_D405_STAGE_MOUNT_OFFSET_XYZ_M:-}"
  -e "A1Z_D405_STAGE_MOUNT_RPY_DEG=${A1Z_D405_STAGE_MOUNT_RPY_DEG:-}"
  -e "A1Z_D405_BODY_VISUAL_RPY_DEG=${A1Z_D405_BODY_VISUAL_RPY_DEG:-}"
  -e "A1Z_D405_STAGE_RECTIFY_RPY_DEG=${A1Z_D405_STAGE_RECTIFY_RPY_DEG:-}"
  -e "A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_OFFSET_XYZ_M=${A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_OFFSET_XYZ_M:-}"
  -e "A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_RPY_DEG=${A1Z_D405_STAGE_RECTIFIED_TO_OPTICAL_RPY_DEG:-}"
  ...
  -e "A1Z_D405_RECTIFIED_FRAME_ID=${A1Z_D405_RECTIFIED_FRAME_ID:-}"
